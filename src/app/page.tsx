      ...
      <Section size={{initial: "1", md: "2", lg: "3"}} pl="3" pr="3">
        <Container size="4">
          <Flex direction="column" gap="4" className="max-w-lg">
            ...
            <Text>
              These are some tools I've been developing to help myself train and
              race. If you have suggestions, feedback, or bugs, please <RadixLink href="mailto:miloknowles97@gmail.com">let me know.</RadixLink>
            </Text>
            <Text>
              If you'd like to contribute to this open-source project, check out the <RadixLink href="https://github.com/miloknowles/triathlon-tools">repository on Github.</RadixLink>
            </Text>
          </Flex>
